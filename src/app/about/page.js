      ...
      <section className="section bg-light" style={{ background: "linear-gradient(to bottom, #F8FAFC, #FFFFFF)" }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: "50px" }}>
            <div className="section-label" style={{ background: "#E6F4EA", color: "#0B3A26", padding: "6px 14px", borderRadius: "20px", display: "inline-block", fontSize: "12px", fontWeight: "700", marginBottom: "16px" }}>ABOUT US</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "30px", marginBottom: "60px" }}>
            <div style={{ background: "#FFFFFF", padding: "40px", borderRadius: "16px", border: "1px solid #E2E8F0", boxShadow: "0 10px 30px rgba(0,0,0,0.03)", position: "relative", overflow: "hidden" }}>
              <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "4px", background: "#0B3A26" }}></div>
          ...
          <div style={{ display: "flex", gap: "50px", flexWrap: "wrap", alignItems: "center" }}>
            <div style={{ flex: 1.5, minWidth: "300px" }}>
              ...
              <div style={{ width: "60px", height: "4px", background: "#0B3A26", marginBottom: "24px", borderRadius: "2px" }}></div>
              <p style={{ color: "#475569", lineHeight: "1.8", marginBottom: "16px", fontSize: "15px" }}>
                ...
                <strong style={{ color: "#0B3A26" }}>Imports:</strong> We import kids wear, mens wear, beauty cosmetics, ladies under garments & much more from China to India, ensuring the latest trends and best quality for our domestic market.
              </p>
              <p style={{ color: "#475569", lineHeight: "1.8", marginBottom: "16px", fontSize: "15px" }}>
                <strong style={{ color: "#0B3A26" }}>Exports:</strong> We export premium agricultural products like rice, fruits, vegetables, pulses, spices & much more to the UAE. We also export building safety tools, hardware material, machinery, trucks, dumpers, JCB, rice, spices & much more to Africa & South Africa.
              </p>
            </div>
            
            <div style={{ flex: 1, minWidth: "300px", background: "#0B3A26", padding: "40px", borderRadius: "20px", color: "#FFFFFF", boxShadow: "0 20px 40px rgba(11, 58, 38, 0.15)" }}>
