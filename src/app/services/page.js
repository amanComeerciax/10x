      ...
      <section className="section bg-light" style={{ background: "linear-gradient(to bottom, #F8FAFC, #FFFFFF)" }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: "50px" }}>
            <div className="section-label" style={{ background: "#E6F4EA", color: "#0B3A26", padding: "6px 14px", borderRadius: "20px", display: "inline-block", fontSize: "12px", fontWeight: "700", marginBottom: "16px" }}>OUR SERVICES</div>
        ...
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "30px" }}>
            <div style={{ background: "#FFFFFF", padding: "40px", borderRadius: "20px", border: "1px solid #E2E8F0", boxShadow: "0 10px 30px rgba(0,0,0,0.04)", transition: "transform 0.3s" }}>
              <div style={{ width: "64px", height: "64px", borderRadius: "16px", background: "#0B3A26", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "24px" }}>
